...
$(function () {
    ...
    $('#archiveData').click(function () {
        handleRequest(`${adminUrl}home/archive-campuses`, selectedIds, 'PUT', {}, '#initBtTable', 'are you sure you want to archive selected Campuses?');
    });

    $(document).on('click', '.makeItDefault', function (e) {
        e.preventDefault();
        const campusId = $(this).data('id');
        handleRequest(`${adminUrl}home/make-campus-default/${campusId}`, selectedIds, 'PUT', {}, '#initBtTable', 'Are you sure you want to make this campus default?');
    });

    handleSubmit('#campusForm');
});
