...
typeof (CKEDITOR) != 'undefined' && CKEDITOR.replace('description', {
    height: 300,
    toolbar: [{
        name: 'basicstyles',
...
$(function () {
    ...
    $('#archiveData').click(function () {
        handleRequest(`${adminUrl}admissions/archive-admission-info-data`, selectedIds, 'PUT', {}, '#initBtTable', 'are you sure you want to archive selected Admission info?');
    });
