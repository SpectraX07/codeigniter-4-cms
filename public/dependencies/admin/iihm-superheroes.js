...
$(function () {
    ...
    $('#superhero-gallery').length && $('#superhero-gallery').FancyFileUpload({
        url: `${adminUrl}placements/iihm-superheroes`,
        params: {
            action: 'fileuploader'
        },
        edit: false,
    ...
    $('#archiveData').click(function () {
        handleRequest(`${adminUrl}placements/archive-superheroes`, selectedIds, 'PUT', {}, '#initBtTable', 'are you sure you want to archive selected Superheroes?');
    });
    ...
    $(document).on('click', '.triggerEdit', function (e) {
        ...
        $('#showSuperheroImage').attr('src', response.image);
