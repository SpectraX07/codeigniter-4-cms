...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const textInput = document.getElementById('awardLinkOrFile');
    const fileInput = document.getElementById('awardLinkOrFileFile');

    if (toggleButton && textInput && fileInput) {
        toggleButton.addEventListener('click', function () {
            if (textInput.style.display === 'none') {
                textInput.style.display = '';
                textInput.setAttribute('name', 'awardLinkOrFile');
...
$(function () {
    ...
    $('#archiveData').click(function () {
        handleRequest(`${adminUrl}my-iihm/archive-award-n-recognition`, selectedIds, 'PUT', {}, '#initBtTable', 'are you sure you want to archive selected Awards & Recognitions?');
    });

    handleSubmit('#awardForm');
});
