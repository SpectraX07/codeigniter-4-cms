...
$(function () {
    ...
    $('#placement-gallery').length && $('#placement-gallery').FancyFileUpload({
        url: `${adminUrl}placements/iihm-placement-gallery/${$('#placement-gallery').data('id')}`,
        params: {
            action: 'fileuploader'
        },
        edit: false,
    ...
    $('#archiveData').click(function () {
        handleRequest(`${adminUrl}placements/archive-placements`, selectedIds, 'PUT', {}, '#initBtTable', 'are you sure you want to archive selected Placements?');
    });
    $('#deleteImageData').click(function () {
        handleRequest(`${adminUrl}placements/delete-placement-images`, selectedIds, 'DELETE', {}, '#initBtTable', 'are you sure you want to delete selected Images?');
    });
